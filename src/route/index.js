...
var header = {
  ...
  salary: '600$ в мiс',
  address: 'вулиця Януша Корчака, 30, Київ,',
}
          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'Pet project for parsing sport betting data from different platforms',
                },
                {
                  name: ' money line - first win / draw / second win, totals etc.',
                },
              ],
              awardAmount: '19',
            },
